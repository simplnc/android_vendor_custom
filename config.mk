...
# Media and Tool Applications (7 apps)
PRODUCT_PACKAGES += \
    ambient.music \
    com.mardous.booming \
    recordyou \
...
# Commented out to fix bootloop - permissions handled via prebuilt_etc_xml in Android.bp if needed
# PRODUCT_COPY_FILES += \
